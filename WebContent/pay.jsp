	...
	<head>
		...
		<script type="text/javascript">
			...
			$(function(){
				...
				// 给默认地址添加默认标签
				$("#default_1").find(".address-left").append("<ins class='deftip'>默认地址</ins>");
				$("#default_1").attr("class","user-addresslist defaultAddr");
					...
					<div class="address">
						...
						<ul class="addressChoose">
								...
								<c:forEach items="${addressList}" var="address">
									<li class="user-addresslist" id="default_${address.isdefault}">
...
<!-- 												<ins class="deftip">默认地址</ins> -->
					...
					<c:forEach items="${sessionScope.shopCart.list}" var="good">
							<!-- 购物车 -->
							<tr class="item-list">
...
<!-- 													          <input class="add am-btn" name="" type="button" value="+"  id="jia"/> -->
											...
											<li class="td td-sum">
												<div class="td-inner">
													<em tabindex="0" class="J_ItemSum number" id="singlePrice"><fmt:formatNumber type="number" value="${good.goods_price_off*good.count}" pattern="#.##"/></em>
												</div>
											</li>
							...
							<div class="order-go clearfix">
								<div class="pay-confirm clearfix">
                                    ...
                                    <span>¥</span> <em class="style-large-bold-red " id="J_ActualFee">${sessionScope.shopCart.price}</em>
											</span>
										</div>
