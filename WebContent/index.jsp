					   ...
					   <div class="nav-cont">
						...
						<div id="nav" class="navfull">
							<div class="area clearfix">
								...
								<c:if test="${big.goods_type_parentid eq '0'}">
									<div class="category">
										<ul class="category-list" id="js_climit_li">
											<li class="appliance js_toggle relative first">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="images/${big.goods_type_pic}"></i><a class="ml-22" title="点心">${big.goods_type_name}</a></h3>
													<em>&gt;</em></div>
														...
														<div class="area-bg">
															<div class="menu-srot">									
																...
																<c:forEach items="${gtList}" var="small">	
																	<c:if test="${big.id eq small.goods_type_parentid}">	
																	<dl class="dl-sort">															
																		<dt><span title="${small.goods_type_name}">${small.goods_type_name}</span></dt>
