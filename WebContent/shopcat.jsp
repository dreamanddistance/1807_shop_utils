...
// 			$("#count_"+id).val(count+1);
				...
				param.id = id;
				param.count = count+1;
			$.post("ShopServlet?action=updateGoodsInfoDomainCount",param,function(){
				location.reload();
			});
		}
	}
...
<body>
	...
	<div class="concent">
		<div id="cartTable">
			...
			<c:forEach items="${sessionScope.shopCart.list}" var="goodsInfoDomain">
					...
					<div class="bundle  bundle-last ">
						...
						<!-- 购物车 -->
							<ul class="item-content clearfix">
								...
								<li class="td td-sum">
									<div class="td-inner">
										<em tabindex="0" class="J_ItemSum number" ><fm:formatNumber value="${goodsInfoDomain.goods_price_off*goodsInfoDomain.count}" pattern="#.##"/></em>
									</div>
								</li>
								<li class="td td-op">
									<div class="td-inner">
									<a href="ShopServlet?action=deleteGoodsInfoDomain&id=${goodsInfoDomain.id}" data-point-url="#" class="delete"> 删除</a>
									</div>
								</li>
		...
		<div class="float-bar-wrapper">
			<div class="float-bar-right">
				...
				<div class="price-sum">
					...
					<strong class="price">
					¥<em id="J_Total"></em>
					${sessionScope.shopCart.price}
					</strong>
				</div>
				<div class="btn-area">
					<a href="ShopServlet?action=gotoPay" id="J_Go" class="submit-btn submit-btn-disabled"
